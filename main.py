...
class MainApp(App):
    ...
    def loading_func(self,dt):
      if self.first:
        self.Music=SoundLoader.load(resource_find('Assets/music.mp3'))        
        self.Music.volume=0.5          
        self.Music.loop=True           
            
        self.startup=SoundLoader.load(resource_find('Assets/startup.mp3'))
            
        self.wrong_sound=SoundLoader.load(resource_find('Assets/wrong.mp3'))
            
        self.correct_sound=SoundLoader.load(resource_find('Assets/correct.mp3'))
    ...
    def Main_build(self,instance):
        ...
        img=ImageButton(resource_find('Assets/math.jpg'),resource_find('Assets/math.jpg'),(0.03,0.2),(0.5,0.2),'',self.math)
        img2=ImageButton(resource_find('Assets/jadval_zarb.png'),resource_find('Assets/jadval_zarb.png'),(0.501,0.201),(0.45,0.2),'',self.jadval_zarb)
        img3=ImageButton(resource_find('Assets/poster.png'),resource_find('Assets/poster.png'),(0.17,0.5),(0.7,0.24),'',lambda instance:'')
        img4=ImageButton(resource_find('Assets/toolbar.png'),resource_find('Assets/toolbar.png'),(0,0.9),(1,0.05),'',lambda instance:'')
        #img=ImageButton(picture,picture,(pos[0],pos[1]+100),(350,150),'',lambda instance:'')
#        img=ImageButton(resource_find('Assets/coins.jpg'),resource_find('Assets/coins.jpg'),(400,3920),(50,56),'',self.Tab3_drawer)
             ...
             if state=='left':
                ...
                if i%2==0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        img = ImageButtonWithPos(resource_find('Assets/green.png'),resource_find('Assets/green_down.png'),(x,y),(184,171),abs(i-10),lambda instance:'') 
                    elif data_get(get_user(),'Level_jadval_zarb')==abs(i-10):
                        img = ImageButtonWithPos(resource_find('Assets/blue.png'),resource_find('Assets/blue_down.png'),(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    else:
                     img = ImageButtonWithPos(resource_find('Assets/gray.png'),resource_find('Assets/gray_down.png'),(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    self.layout.add_widget(img)
                ...
                if i%2!=0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        ...
                        img = ImageButtonWithPos(resource_find('Assets/gray.png'),resource_find('Assets/gray_down.png'),(x,y),(184,171),abs(i-10),lambda instance:'') 
    ...
    def math(self,instance):
        ...
        if data_get(get_user(),'Level_math')%2!=0:
            ...
            self.character=Image(source=resource_find('Assets/boy_standup.png'),pos=(-190,780-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
            ...
            self.character=Image(source=resource_find('Assets/boy_standup_rtl.png'),pos=(200,880-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
    ...
    def math_level(self,instance):
          ...
          self.timer=Label(pos=(-180,380),text='30',font_size=50,pos_hint={"x":-0.3,"y":0.4},color=(0,0,0,1))


          self.correct_incorrect=Label(pos=(0,-250),text='',font_size=50,pos_hint={"x":0,"y":-0.1},color=(0,0,0,1))
    ...
    def math_level_medium(self,instance):
          ...
          self.timer=Label(pos=(-180,380),text='40',font_size=50,pos_hint={"x":-0.3,"y":0.4},color=(0,0,0,1))
    ...
    def math_level_hard(self,instance):
          ...
          self.timer=Label(pos=(-180,380),text='60',font_size=50,pos_hint={"x":-0.3,"y":0.4},color=(0,0,0,1))
    ...
    def create_math_question(self,state):
          ...
          with open(resource_find(f'Data/math_{state}.json'),'r',encoding='utf-8') as data:
          ...
          self.layout.add_widget(Label(pos=(0,300),text=convert_to_persian(question),halign='right',valign='top',font_size=60,color=(0,0,0,1),pos_hint={"x":0,"y":0.3}))


          self.btn1=Button(text=convert_to_persian(answers[0]),pos=(325,1200),font_size=50,color=(1,1,1,1),size_hint=(None,None),size=(200,200),border=(1,1,1,1))


          self.btn2=Button(text=convert_to_persian(answers[1]),pos=(525,1200),font_size=50,color=(1,1,1,1),size_hint=(None,None),size=(200,200),border=(1,1,1,1))


          self.btn3=Button(text=convert_to_persian(answers[2]),pos=(325,1000),font_size=50,color=(1,1,1,1),size_hint=(None,None),size=(200,200),border=(1,1,1,1))


          self.btn4=Button(text=convert_to_persian(answers[3]),pos=(525,1000),font_size=50,color=(1,1,1,1),size_hint=(None,None),size=(200,200),border=(1,1,1,1))
    ...
    def Tab3_drawer(self, instance):
        ...
        panel=TabbedPanel(do_default_tab=False,tab_pos='top_mid',pos_hint={"x":0.27,"y":0.45},size_hint=(1, None),height=1800,background_color=(0,0,1,0))
    ...
    def Tabs_drawer(self):
        btn1 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.05, "y": 0.02},background_normal=resource_find('Assets/level.jpg'),background_down=resource_find('Assets/level.jpg'),border=(0, 0, 0, 0),on_press=self.Main_build,text="")
        self.tabs.add_widget(btn1)
        btn2 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.28, "y": 0.02},background_normal=resource_find('Assets/game.png'),background_down=resource_find('Assets/game.png'),border=(0, 0, 0, 0),on_press=self.Tab2_drawer,text="")
        self.tabs.add_widget(btn2)
        btn3 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.52, "y": 0.02},background_normal=resource_find('Assets/shop.jpg'),background_down=resource_find('Assets/shop.jpg'),border=(0, 0, 0, 0),on_press=self.Tab3_drawer,text="")
        self.tabs.add_widget(btn3)
        btn4 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.75, "y": 0.02},background_normal=resource_find('Assets/setting.jpg'),background_down=resource_find('Assets/setting.jpg'),border=(0, 0, 0, 0),on_press=self.Tab4_drawer,text="")
    ...
    def tic_tac_toe_level(self, instance):
        ...
        img = Image(source=resource_find('Assets/Tic-tac-toe-Game-Board.jpg'), pos=(0, 480), size_hint=(None, None), size=(450, 400),pos_hint={"x":0.3,"y":0.7})
