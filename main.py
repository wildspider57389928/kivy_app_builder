...
path = resource_find('Assets/B-NAZANIN.TTF')
...
def create_user(username):
     ...
     if not os.path.exists(f'{os.path.join(app_storage_path(), "AppData")}/sys11209.json'):


        os.mkdir(f'{os.path.join(app_storage_path(), "AppData")}')


        with open(f'{os.path.join(app_storage_path(), "AppData")}/sys11209.json', 'a') as data:
        ...
        with open(f'{os.path.join(app_storage_path(), "AppData")}/sys11209.json', 'w') as data:
...
class MainApp(App):
    ...
    def loading_func(self,dt):
      if self.first:
        self.Music=SoundLoader.load(f'{os.path.join(app_storage_path(), "Assets")}/music.mp3')             
        self.Music.volume=0.5          
        self.Music.loop=True
            
        self.startup=SoundLoader.load(f'{os.path.join(app_storage_path(), "Assets")}/startup.mp3')
            
        self.wrong_sound=SoundLoader.load(f'{os.path.join(app_storage_path(), "Assets")}/wrong.mp3')
            
        self.correct_sound=SoundLoader.load(f'{os.path.join(app_storage_path(), "Assets")}/correct.mp3')
    ...
    def buil(self):
        ...
        img=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/coins.jpg",f"{os.path.join(app_storage_path(), 'Assets')}/coins.jpg",(400,3920),(50,56),'',lambda instance:'')


        self.layout.add_widget(img)


        if os.path.exists(f'{os.path.join(app_storage_path(), "AppData")}/user_pic.png'):


            img=ImageButton(f'{os.path.join(app_storage_path(), "AppData")}/user_pic.png',f'{os.path.join(app_storage_path(), "AppData")}/user_pic.png',(0,3872),(80,150),'',self.user_picture)        


        else:img=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/user.jpg",f"{os.path.join(app_storage_path(), 'Assets')}/user.jpg",(0,3920),(50,56),'',self.user_picture)
    ...
    def Main_build(self,instance):
        ...
        img=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/math.jpg",f"{os.path.join(app_storage_path(), 'Assets')}/math.jpg",(0.03,0.2),(0.5,0.2),'',self.math)
        img2=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/jadval_zarb.png",f"{os.path.join(app_storage_path(), 'Assets')}/jadval_zarb.png",(0.501,0.201),(0.45,0.2),'',self.jadval_zarb)
        img3=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/poster.png",f"{os.path.join(app_storage_path(), 'Assets')}/poster.png",(0.17,0.5),(0.7,0.24),'',lambda instance:'')
        img4=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/toolbar.png",f"{os.path.join(app_storage_path(), 'Assets')}/toolbar.png",(0,0.9),(1,0.05),'',lambda instance:'')
        #img=ImageButton(picture,picture,(pos[0],pos[1]+100),(350,150),'',lambda instance:'')
#        img=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/coins.jpg",f"{os.path.join(app_storage_path(), 'Assets')}/coins.jpg",(400,3920),(50,56),'',self.Tab3_drawer)
             ...
             if state=='left':
                ...
                if i%2==0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        img = ImageButtonWithPos(f"{os.path.join(app_storage_path(), 'Assets')}/green.png",f"{os.path.join(app_storage_path(), 'Assets')}/green_down.png",(x,y),(184,171),abs(i-10),lambda instance:'') 
                    elif data_get(get_user(),'Level_jadval_zarb')==abs(i-10):
                        img = ImageButtonWithPos(f"{os.path.join(app_storage_path(), 'Assets')}/blue.png",f"{os.path.join(app_storage_path(), 'Assets')}/blue_down.png",(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    else:
                     img = ImageButtonWithPos(f"{os.path.join(app_storage_path(), 'Assets')}/gray.png",f"{os.path.join(app_storage_path(), 'Assets')}/gray_down.png",(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    self.layout.add_widget(img)
                ...
                if i%2!=0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        ...
                        img = ImageButtonWithPos(f"{os.path.join(app_storage_path(), 'Assets')}/gray.png",f"{os.path.join(app_storage_path(), 'Assets')}/gray_down.png",(x,y),(184,171),abs(i-10),lambda instance:'') 
    ...
    def math(self,instance):
        ...
        if data_get(get_user(),'Level_math')%2!=0:
            ...
            self.character=Image(source=f"{os.path.join(app_storage_path(), 'Assets')}/boy_standup.png",pos=(-190,780-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
            ...
            self.character=Image(source=f"{os.path.join(app_storage_path(), 'Assets')}/boy_standup_rtl.png",pos=(200,880-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
    ...
    def create_math_question(self,state):
          ...
          with open(f'{os.path.join(app_storage_path(), "Assets")}/math_{state}.json','r',encoding='utf-8') as data:
    ...
    def save_pic(self,instance):
        ...
        self.cam.export_to_png(f'{os.path.join(app_storage_path(), "AppData")}/user_pic.png')    
    ...
    def Tab4_drawer(self,instance):
        ...
        img=ImageButton(f"{os.path.join(app_storage_path(), 'Assets')}/toolbar.png",f"{os.path.join(app_storage_path(), 'Assets')}/toolbar.png",(0,0.949),(1,0.05),'',lambda instance:'')
    ...
    def Tabs_drawer(self):
        btn1 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.05, "y": 0.02},background_normal=f"{os.path.join(app_storage_path(), 'Assets')}/level.jpg",background_down=f"{os.path.join(app_storage_path(), 'Assets')}/level.jpg",border=(0, 0, 0, 0),on_press=self.Main_build,text="")
        self.tabs.add_widget(btn1)
        btn2 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.28, "y": 0.02},background_normal=f"{os.path.join(app_storage_path(), 'Assets')}/game.png",background_down=f"{os.path.join(app_storage_path(), 'Assets')}/game.png",border=(0, 0, 0, 0),on_press=self.Tab2_drawer,text="")
        self.tabs.add_widget(btn2)
        btn3 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.52, "y": 0.02},background_normal=f"{os.path.join(app_storage_path(), 'Assets')}/shop.jpg",background_down=f"{os.path.join(app_storage_path(), 'Assets')}/shop.jpg",border=(0, 0, 0, 0),on_press=self.Tab3_drawer,text="")
        self.tabs.add_widget(btn3)
        btn4 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.75, "y": 0.02},background_normal=f"{os.path.join(app_storage_path(), 'Assets')}/setting.jpg",background_down=f"{os.path.join(app_storage_path(), 'Assets')}/setting.jpg",border=(0, 0, 0, 0),on_press=self.Tab4_drawer,text="")
    ...
    def tic_tac_toe_level(self, instance):
        ...
        img = Image(source=f'{os.path.join(app_storage_path(), "Assets")}/Tic-tac-toe-Game-Board.jpg', pos=(0, 480), size_hint=(None, None), size=(450, 400),pos_hint={"x":0.3,"y":0.7})
