...
s
    ...
    def turn_changer(self,instance):
        ...
        img=Image(source=ff'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/dice{dicen}.png', pos=(170,320), size_hint=(None, None), size=(10,10))
