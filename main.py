...
files_dir = autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()
os.environ['KIVY_HOME'] = files_dir
...
Config.set('kivy','default_font',[f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Kalameh-Regular.ttf',f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Kalameh-Regular.ttf',f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Kalameh-Regular.ttf',f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Kalameh-Regular.ttf'])
...
class MainApp(App):
    ...
    def loading_func(self,dt):
      if self.first:
        self.Music=SoundLoader.load(f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/music.mp3')             
   
        self.Music.volume=0.5            
            
        self.Music.loop=True
            
        self.startup=SoundLoader.load(f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/startup.mp3')
            
        self.wrong_sound=SoundLoader.load(f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/wrong.mp3')
            
        self.correct_sound=SoundLoader.load(f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/correct.mp3')
    ...
    def buil(self):
        ...
        img=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/coins.jpg",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/coins.jpg",(400,3920),(50,56),'',lambda instance:'')
        ...
        else:img=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/user.jpg",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/user.jpg",(0,3920),(50,56),'',self.user_picture)
    ...
    def Main_build(self,instance):
        ...
        img=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/math.jpg",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/math.jpg",(0.03,0.2),(0.5,0.2),'',self.math)
        img2=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/jadval_zarb.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/jadval_zarb.png",(0.501,0.201),(0.45,0.2),'',self.jadval_zarb)
        img3=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/poster.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/poster.png",(0.17,0.5),(0.7,0.24),'',lambda instance:'')
        img4=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/toolbar.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/toolbar.png",(0,0.9),(1,0.05),'',lambda instance:'')
        #img=ImageButton(picture,picture,(pos[0],pos[1]+100),(350,150),'',lambda instance:'')
#        img=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/coins.jpg",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/coins.jpg",(400,3920),(50,56),'',self.Tab3_drawer)
    ...
    def jadval_zarb(self,instance):
        ...
        self.layout.size=(360,1900)


        self.layout.add_widget(BlueScreen())

        self.level_drawer(Window.width*0.25,-700,'right',self.level)


        self.level_drawer(Window.width*0.6,-700,'left',self.level)
             ...
             if state=='left':
                ...
                if i%2==0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        img = ImageButtonWithPos(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/green.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/green_down.png",(x,y),(184,171),abs(i-10),lambda instance:'') 
                    elif data_get(get_user(),'Level_jadval_zarb')==abs(i-10):
                        img = ImageButtonWithPos(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/blue.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/blue_down.png",(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    else:
                     img = ImageButtonWithPos(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/gray.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/gray_down.png",(x,y),(184,171),abs(i-10),lambda instance:self.level_preview(instance,command)) 
                    self.layout.add_widget(img)
                ...
                if i%2!=0:
                    ...
                    if data_get(get_user(),'Level_jadval_zarb')>abs(i-10):
                        ...
                        img = ImageButtonWithPos(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/gray.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/gray_down.png",(x,y),(184,171),abs(i-10),lambda instance:'') 
             ...
             if state=='left':
                ...
                if i%2==0:
                    ...
                    if data_get(get_user(),'Level_math')>abs(i-10):
                        ...
                        img = ImageButtonWithPos(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/green.png",f"{autoclass('org.kivy.android.PythonActivisty').mActivity.getFilesDir().getAbsolutePath()}/Assets/green_down.png",(x,y),(184,171),abs(i-10),lambda instance:'') 
    ...
    def math(self,instance):
        ...
        if data_get(get_user(),'Level_math')%2!=0:
            ...
            self.character=Image(source=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/boy_standup.png",pos=(-190,780-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
            ...
            self.character=Image(source=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/boy_standup_rtl.png",pos=(200,880-(data_get(get_user(),'Level_math')//2*220)),size=(56,81))
    ...
    def create_math_question(self,state):
          ...
          with open(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/data/math_{state}.json",'r',encoding='utf-8') as data:
    ...
    def Tab2_drawer(self,instance):
        ...
        self.layout.add_widget(Button(text=convert_to_persian('مار و پله'), color=(0, 1, 1, 1), size_hint=(0.33, None), size=(400, 100), pos=(0, 1200), on_press=self.snake_level,pos_hint={"x":0.68}))
    ...
    def Tab3_drawer(self, instance):
        ...
        panel=TabbedPanel(do_default_tab=False,tab_pos='top_mid',pos_hint={"x":0.27,"y":0},size_hint=(None, None),size=(460,1800),background_color=(0,0,1,0))
        ...
        coins_layout.add_widget(Product('100 امتیاز','بسته مبتدی','100 هزار تومان ',size_hint=(10,10),pos_hint={"x":0.5,"y":0}))
	

        coins_layout.add_widget(Product('200 امتیاز','بسته متوسط','200 هزار تومان'))


        coins_layout.add_widget(Product('300 امتیاز','بسته محبوب','400 هزار تومان'))


        coins_layout.add_widget(Product('600 امتیاز','بسته شگفت انگیز','600 هزار تومان'))


        boosters_layout.add_widget(Product('زمان+','پنج دقیقه زمان برای سوالات','50 سکه'))


        boosters_layout.add_widget(Product('50-50','حذف کردن دو گزینه نادرست','100 سکه'))


        boosters_layout.add_widget(Product('پرش','پرش از پنج سوال','200 سکه'))


        boosters_layout.add_widget(Product('4 برابر','چهار برابر کردن امتیاز','300 سکه'))
    ...
    def Tab4_drawer(self,instance):
        ...
        img=ImageButton(f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/toolbar.png",f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/toolbar.png",(0,0.949),(1,0.05),'',lambda instance:'')
    ...
    def Tabs_drawer(self):
        btn1 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.05, "y": 0.02},background_normal=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/level.jpg",background_down=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/level.jpg",border=(0, 0, 0, 0),on_press=self.Main_build,text="")
        self.tabs.add_widget(btn1)
        btn2 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.28, "y": 0.02},background_normal=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/game.png",background_down=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/game.png",border=(0, 0, 0, 0),on_press=self.Tab2_drawer,text="")
        self.tabs.add_widget(btn2)
        btn3 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.52, "y": 0.02},background_normal=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/shop.jpg",background_down=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/shop.jpg",border=(0, 0, 0, 0),on_press=self.Tab3_drawer,text="")
        self.tabs.add_widget(btn3)
        btn4 = Button(size_hint=(0.20, 0.15),pos_hint={"x": 0.75, "y": 0.02},background_normal=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/setting.jpg",background_down=f"{autoclass('org.kivy.android.PythonActivity').mActivity.getFilesDir().getAbsolutePath()}/Assets/setting.jpg",border=(0, 0, 0, 0),on_press=self.Tab4_drawer,text="")
    ...
    def snake_level(self, instance):
        ...
        img = Image(source=f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/snakes-and-ladders.jpg', pos=(0, 355), size_hint=(None, None), size=(450, 640))


        self.player1=Image(source=f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Player1.png', pos=(10,447), size_hint=(None, None), size=(29, 66))


        self.player2=Image(source=f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Player2.png', pos=(20,447), size_hint=(None, None), size=(29, 66))
    ...
    def turn_changer(self,instance):
        ...
        img=Image(source=f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/dice{dicen}.png', pos=(170,320), size_hint=(None, None), size=(10,10))
    ...
    def tic_tac_toe_level(self, instance):
        ...
        img = Image(source=f'{autoclass("org.kivy.android.PythonActivity").mActivity.getFilesDir().getAbsolutePath()}/Assets/Tic-tac-toe-Game-Board.jpg', pos=(0, 480), size_hint=(None, None), size=(450, 400))
